                    ...
                    <div className="w-full md:w-auto space-y-4">
                        <div className="space-y-2 text-right">
                            ...
                            <div className="flex gap-4 justify-end">
                                <a 
                                    href="https://www.instagram.com/_krish1604/" 
                                    target="_blank" 
                                ...
                                <a 
                                    href="https://github.com/krish-1604" 
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    className="text-black hover:text-white/80 transition-colors"
                                    >
                        ...
                        <button
                            className="w-full md:w-auto bg-transparent text-white px-4 md:px-6 py-2 rounded-[10px] border-2 border-black hover:bg-white hover:text-[#FF8A50] transition-colors duration-300 flex items-center justify-center gap-2 text-sm md:text-base"
                            onClick={() => {
